...
final verifySignupEmailProvider = StateNotifierProvider.autoDispose<
    VerifySignupEmailNotifier, VerifySignupEmailState>((ref) {
...
class VerifySignupEmailState {
  ...
  VerifySignupEmailState copyWith({
    String? code,
    String? errorMessage,
    bool? isWaiting,
    int? secondsLeft,
...
class VerifySignupEmailNotifier extends StateNotifier<VerifySignupEmailState> {
  ...
  void resendCode() {
    // TODO: call API gửi email đăng ký tại đây
    _startCooldown();
  }
