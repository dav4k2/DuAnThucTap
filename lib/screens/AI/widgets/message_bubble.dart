...
class MessageBubble extends StatelessWidget {
  final ChatMessage msg; // Sử dụng tên biến 'msg' cho ngắn gọn
  final bool isDark;
        ...
        children: [
          ...
          if (hasRecipe)
            RecipePreviewCard(
              data: msg.recipeData!,
              isDark: isDark,
              onCookNow: () => onCookNow(msg.recipeData!),
              onChangeRecipe: onRequestAnother,
            ),
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _iconText(Icons.timer_outlined, data['cookingTime'], subColor),
              _iconText(Icons.people_outline, data['servings'], subColor),
              _iconText(Icons.bar_chart_rounded, data['difficulty'], subColor),
            ],
          ),
          ...
          Text(data['description'] ?? '',
              style: TextStyle(
                  fontSize: 15.sp, color: subColor, height: 1.5)),
