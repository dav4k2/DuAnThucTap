// lib/widgets/review_filter_header.dart
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import '../logic/chef_provider.dart';

class ReviewFilterHeader extends ConsumerWidget {
  const ReviewFilterHeader({super.key});
  ...
  Widget _chip(String label, ReviewFilter value, bool active, StateController<ReviewFilter> notifier) {
...
class ReviewFilterDelegate extends SliverPersistentHeaderDelegate {
  @override
